...
async function GET(request) {
    ...
    if (code) {
        ...
        if (!error) {
            const forwardedHost = request.headers.get('x-forwarded-host') // 處理部署後的網域問題
            ;
            const isLocalEnv = ("TURBOPACK compile-time value", "development") === 'development';
            if ("TURBOPACK compile-time truthy", 1) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}${next}`);
            } else //TURBOPACK unreachable
            ;
        }
    }
    // 如果失敗，導回登入頁並帶上錯誤訊息
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/login?error=auth_code_error`);
}
}),
];
