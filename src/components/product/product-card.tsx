    ...
    <div
      ...
      <div className='flex flex-1 flex-col p-2.5 sm:p-4'>
        ...
        <div className='mb-1.5 flex items-center justify-between'>
          <div className='max-w-[60%] truncate text-[10px] font-bold tracking-widest text-gray-400 uppercase sm:text-[12px]'>
            {brand ? brand.replace(/_/g, ' ') : ''}
          </div>

          {location && (
            <div className='flex flex-shrink-0 items-center gap-0.5 text-[10px] text-gray-400 sm:text-[12px]'>
