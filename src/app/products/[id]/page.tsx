      ...
      <div className='container mx-auto px-4 lg:px-6'>
        ...
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12'>
          ...
          <div className='col-span-1 lg:col-span-5'>
            <div className='relative mx-auto aspect-[4/3] max-h-[50vh] w-full overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 lg:aspect-square lg:max-h-none'>
              {/* 狀態遮罩 */}
            ...
            <div className='space-y-6 lg:sticky lg:top-28'>
              ...
              <div className='grid grid-cols-2 gap-3'>
                <div className='flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50/50 p-3'>
                  <div className='flex h-8 w-8 items-center justify-center rounded-full bg-white text-gray-500 shadow-sm'>
              ...
              {/* 安全提示 */}
              <div className='flex gap-3 rounded-xl bg-blue-50/50 p-3 text-xs leading-relaxed text-blue-800/80'>
        ...
        {/*
                ...
                */}
        <div className='safe-area-bottom fixed right-0 bottom-0 left-0 z-20 border-t border-gray-100 bg-white/90 p-3 pb-6 backdrop-blur-md lg:hidden'>
          <div className='flex items-center gap-3'>
