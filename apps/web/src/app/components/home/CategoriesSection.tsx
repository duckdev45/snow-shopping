            ...
            <div className="container mx-auto px-4 lg:px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
                    {categories.map((category) => (
                        <Link key={category.name} href={category.href} className="block group text-center p-4 rounded-xl border border-gray-200 hover:shadow-lg hover:border-blue-500 transition-all">
                            <div className="flex items-center justify-center h-24 w-24 bg-blue-100 rounded-full mx-auto mb-4 group-hover:bg-blue-200 transition-colors">
