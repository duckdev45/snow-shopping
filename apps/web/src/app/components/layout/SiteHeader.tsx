    ...
    <header
      className={clsx(
        ...
        // 條件一：控制「背景 & 文字顏色」
        {
          ...
          // 狀態3：離開頂部，且正在「往下滑」
          'bg-background/95 text-primary-foreground backdrop-blur-sm':
      ...
      <nav className='container mx-auto px-4 lg:px-6'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            <LanguageSwitcher />
            <button className='ml-2 hidden items-center rounded-full bg-blue-300 px-4 py-2 text-sm font-medium text-white shadow-md transition-colors hover:bg-blue-700 md:flex'>
