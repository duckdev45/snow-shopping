...
async function getBackendMessage() {
    try {
        ...
        console.error(error); // 這行會把詳細錯誤印在你的 VSCode/WebStorm 終端機
        return '連線到後端失敗了... 檢查一下 api 是不是有跑起來？';
    }
}
...
//# sourceMappingURL=apps_web_85b883e4._.js.map